...
import TagBlot from './modules/tag/blot';
...
implements OnChanges, AfterViewInit, OnDestroy {
	...
	@Output() public readonly textChanged:
		EventEmitter<CUBBasicEditorTextChangedEvent>
		= new EventEmitter();
	@Output() public readonly selectionChanged:
		EventEmitter<CUBBasicEditorSelectionChangedEvent>
		= new EventEmitter();
	@Output( 'focus' ) public readonly focusEE: EventEmitter<void>
		= new EventEmitter();
	@Output( 'blur' ) public readonly blurEE: EventEmitter<void>
		= new EventEmitter();

	@ViewChild( 'editorJS' )
	protected readonly editorJS: ElementRef<HTMLDivElement>;
	...
	private _pasteEventUnlisten: () => void;
	private _compositionStartEventUnlisten: () => void;
	private _compositionEndEventUnlisten: () => void;
	...
	ngAfterViewInit() {
		...
		this._compositionStartEventUnlisten
			= this._renderer.listen(
				rootNode,
				'compositionstart',
				() => {
		...
		this._compositionEndEventUnlisten
			= this._renderer.listen(
				rootNode,
				'compositionend',
				() => {
	...
	public insertMention(
		...
		const module: MentionModule
			= this.getModule<MentionModule>(
				MentionModule.moduleName
			);
