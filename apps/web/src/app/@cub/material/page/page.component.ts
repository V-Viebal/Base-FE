...
export class CUBPageComponent {
	...
	@ContentChild( CUBPageHeaderDirective )
	public pageHeader: CUBPageHeaderDirective;
	@ContentChild( CUBPageContentDirective )
	public pageContent: CUBPageContentDirective;
