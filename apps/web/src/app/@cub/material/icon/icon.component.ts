...
export class CUBIconComponent implements OnChanges {
	...
	get attrColor(): CUBIconColor {
		return this.color as CUBIconColor || undefined;
	}
	...
	public static IMAGE_REGEX: RegExp
		= /(.+)(\.)(jpg|gif|png|svg|webp)$/i;

	@Input() @DefaultValue()
	public type: CUBIconType = 'default';
	@Input() @DefaultValue() @CoerceBoolean()
	public noLazy: boolean = true;
